...
static void __search_callback(struct cs_server_callback_user_data *cud, struct sobj *recv)
{
        ...
        if(total == 1) {
                ...
                string_cat(id, qlkey("_permission_add_employee"));
                ...
                struct string *content = cs_request_string_from_file("res/checking_service/permission_add_employee/create/create.json",
                        FILE_INNER);
