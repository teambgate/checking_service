...
void checking_service_work_time_search_by_date_by_user(struct checking_service *p, struct smart_object *in)
{
        ...
        smart_object_set_string(data, qskey(&__key_cmd__), qskey(&__cmd_work_time_search_by_date_by_user__));
        ...
        cs_request_alloc(local_requester, data, (cs_request_callback)checking_service_work_time_search_by_date_by_user_callback, p);
}
...
void checking_service_work_time_search_by_date_by_user_callback(struct checking_service *p, struct smart_object *recv)
{
        ...
        if(result) {
                ...
                struct smart_array *checks = smart_object_get_array(data, qskey(&__key_work_times__), SMART_GET_REPLACE_IF_WRONG_TYPE);
