...
void checking_service_user_validate(struct checking_service *p, struct smart_object *in)
{
        ...
        smart_object_set_string(data, qskey(&__key_cmd__), qskey(&__cmd_user_validate__));
        ...
        cs_request_alloc(local_requester, data, (cs_request_callback)checking_service_user_validate_callback, p);
}
