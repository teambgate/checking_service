...
void checking_service_work_time_new(struct checking_service *p, struct smart_object *in)
{
        ...
        ADD_INFO(time_start,    "Enter time_start       : ", "time_start");
        ...
        smart_object_set_string(data, qskey(&__key_cmd__), qskey(&__cmd_work_time_new__));
        ...
        smart_object_set_string(data, qskey(&__key_time_start__), qskey(time_start));
        cs_request_alloc(local_requester, data, (cs_request_callback)checking_service_work_time_new_callback, p);
}
