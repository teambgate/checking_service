...
static void __update_ip_callback(struct callback_user_data *cud, struct smart_object *recv)
{
...
void supervisor_process_location_update_ip_port_v1(struct supervisor *p, int fd, u32 mask, struct smart_object *obj)
{
