 ...
 * validate service
 */
static void __update_validated_callback(struct callback_user_data *p, struct smart_object *result)
{
...
static void __update_validate_count_callback(struct callback_user_data *p, struct smart_object *result)
{
