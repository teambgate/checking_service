...
//  * reserve user name
//  */
// static void __reserve_user_name_callback(struct callback_user_data *p, struct sfs_object *recv)
// {
...
//         struct string *_id      = sfs_object_get_string(data, qlkey("_id"), SFS_GET_REPLACE_IF_WRONG_TYPE);
...
static void __register_user_name_callback(struct callback_user_data *cud, struct sfs_object *recv)
{
        struct sfs_object *data = sfs_object_get_object(recv, qskey(&__key_data__), SFS_GET_REPLACE_IF_WRONG_TYPE);
        struct string *result = sfs_object_get_string(data, qlkey("result"), SFS_GET_REPLACE_IF_WRONG_TYPE);
...
static void __register_user_name(struct supervisor *p, int fd, u32 mask, struct sfs_object *obj)
{
        struct string *name             = sfs_object_get_string(obj, qskey(&__key_name__), SFS_GET_REPLACE_IF_WRONG_TYPE);
        struct string *user_name        = sfs_object_get_string(obj, qskey(&__key_user_name__), SFS_GET_REPLACE_IF_WRONG_TYPE);
        struct string *user_pass        = sfs_object_get_string(obj, qskey(&__key_user_pass__), SFS_GET_REPLACE_IF_WRONG_TYPE);
        ...
        sfs_object_set_string(request_data_data, qskey(&__key_validate_code__), qlkey(buf));
